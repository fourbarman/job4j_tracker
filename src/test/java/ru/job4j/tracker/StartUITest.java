...
public class StartUITest {
    ...
    public void whenCreateActionCheckOutput() {
        ...
        expect.add("Item's ID: " + tracker.findAll().get(tracker.findAll().size() - 1).getId()
                + " Item's name: " + tracker.findAll().get(tracker.findAll().size() - 1).getName()
                + " Description: " + tracker.findAll().get(tracker.findAll().size() - 1).getDesc()
                + " Birth time: " + tracker.findAll().get(tracker.findAll().size() - 1).getTime());
        assertThat(new String(out.toByteArray()), is(expect.toString()));
    }
